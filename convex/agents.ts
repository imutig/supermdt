...
export const me = query({
  ...
  handler: async (ctx) => {
    ...
    // Cadet écarté de sa promo : il a des appartenances mais aucune active, donc
    // il perd l'accès LSPA jusqu'à réintégration dans une promo.
