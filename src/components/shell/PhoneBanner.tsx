...
// Bandeau d'avertissement : un agent actif sans numéro de téléphone in-game
// renseigné doit l'indiquer. Masqué pour l'owner, l'académie et l'extérieur.
export function PhoneBanner() {
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">Tu n'as pas encore renseigné ton numéro de téléphone in-game (format <b>555-…</b>).</span>
      <button
