...
const CarteProto = lazyReload(() => import("@/pages/CarteProto").then((m) => ({ default: m.CarteProto })));
  ...
  return (
    ...
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/carte-proto" element={<RequirePerm perm="carte.view"><CarteProto /></RequirePerm>} />
