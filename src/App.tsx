...
const Salaires = lazyReload(() => import("@/pages/Salaires").then((m) => ({ default: m.Salaires })));
  ...
  return (
    ...
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/tenues" element={<RequirePerm perm="tenues.view"><Tenues /></RequirePerm>} />
        ...
        <Route path="/salaires" element={<RequirePerm perm="comptabilite.view"><Salaires /></RequirePerm>} />
